...
class Network {
    public:
        ...
        void update(void (*callback)(Network* network, const uint8_t src, const uint8_t *buffer, const size_t length));
        void receive(bool blocking, void (*callback)(Network* network, const uint8_t src, const uint8_t *buffer, const size_t length));
